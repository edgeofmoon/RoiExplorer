...
// source: https://github.com/pbhogan/Signals
// rename file to avoid conflict with window headers
#ifndef _SimpleSignal_H_
#define _SimpleSignal_H_

#include "SimpleDelegate.h"
#include <set>
using namespace Gallant;
// remove the namespace Gallant spacification
